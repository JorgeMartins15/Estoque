...
public class Componentes implements Serializable {
	...
	public Componentes(Integer id, String nome, String codigo, String fornecedor1, String fornecedor2,
			Integer quantidadeAtual, Integer pontoDePedido, Departamento departamento) {
